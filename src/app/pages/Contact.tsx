                ...
                {[
                  ...
                  <div
                    ...
                    className={`flex-1 p-6 text-center transition-colors ${
                      s.num <= step ? "bg-[#1A3AFF]/10 border-b-2 border-b-[#1A3AFF]" : "bg-background border-b-2 border-b-transparent"
                    }`}
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
                      {projectTypes.map((type) => (
                        <button
                          ...
                          className={`p-6 border transition-colors text-left group flex items-center justify-between ${
